...
export const PRICING_PLANS: PricingPlan[] = [
  ...
  },
  {
    ...
    priceNumeric: 3.5,
    period: '/ 2 თვე',
    monthlyBreakdown: '$1.75 თვეში',
    savingsBadge: 'დაზოგე 12%',
  ...
  },
  {
    ...
    priceNumeric: 5,
    period: '/ 3 თვე',
    monthlyBreakdown: '$1.66 თვეში',
    savingsBadge: 'დაზოგე 17%',
    isPopular: true,
  ...
  },
  {
    ...
    priceNumeric: 8,
    period: '/ 6 თვე',
    monthlyBreakdown: '$1.33 თვეში',
    savingsBadge: 'დაზოგე 33%',
    isBestDeal: true,
    checkoutUrl: '#checkout-6m',
    features: [
      'ყველაზე დიდი ეკონომია ($1.33/თვე)',
